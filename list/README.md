...
- `exibirParesEImpares()`: Exibe os números pares em uma linha e os números ímpares em outra linha.
</p>
...
- `ordenarAscendente()`: Ordena os números da lista em ordem ascendente usando a interface Comparable.
- `ordenarDescendente()`: Ordena os números da lista em ordem descendente usando um Comparator personalizado.
</p>
